...
const u8 gText_BattleFactory[] = _("DREAM FACTORY");
...
const u8 gText_BattleFactoryKnowledgeSymbol[] = _("Dream Factory - Knowledge Symbol");
...
const u8 gText_BattleFactory2[] = _("DREAM FACTORY");
...
const u8 gText_BattleSwapSingleResults[] = _("{PLAYER}'s Dream Factory Single Results");
const u8 gText_BattleSwapDoubleResults[] = _("{PLAYER}'s Dream Factory Double Results");
...
const u8 gText_Lv5Rec[] = _("LV. 5 RECORD");
const u8 gText_Lv5RecShort[] = _("LV. 5 REC.");
const u8 gText_Lv502Rec[] = _("LV. 50 RECORD");
const u8 gText_Lv502RecShort[] = _("LV. 50 REC.");
const u8 gText_OpenLvRec[] = _("OPEN LV. RECORD");
const u8 gText_OpenLvRecShort[] = _("OPEN LV. REC.");
const u8 gText_FinModeRec[] = _("FIN. MODE. RECORD");
const u8 gText_FinModeRecShort[] = _("FN. MODE REC.");
