...
static const u16 sInitialRentalMonRanges[][2] =
{
    ...
    {FRONTIER_MON_ABRA_1,   FRONTIER_MON_YANMA_2},      // A    - 0
    ...
    {FRONTIER_MON_AGGRON_1,  FRONTIER_MON_ZANGOOSE_4},  // C, D - 7
    ...
    {FRONTIER_MON_ABSOL_3,   FRONTIER_MON_XATU_4},      // B, C
    {FRONTIER_MON_AGGRON_1,  FRONTIER_MON_ZANGOOSE_4},  // C, D
    {FRONTIER_MON_AGGRON_1,  FRONTIER_MON_ZANGOOSE_4},  // C, D - 15

    // Open level
    {FRONTIER_MON_AGGRON_1, FRONTIER_MON_ZANGOOSE_4},   // C, D - 16
    {FRONTIER_MON_AGGRON_1, FRONTIER_MON_ZANGOOSE_4},   // C, D
    {FRONTIER_MON_AGGRON_1, FRONTIER_MON_ZANGOOSE_4},   // C, D
    {FRONTIER_MON_AERODACTYL_1, FRONTIER_MON_ZAPDOS_8}, // D, E
    {FRONTIER_MON_AERODACTYL_1, FRONTIER_MON_ZAPDOS_8}, // D, E
    {FRONTIER_MON_AERODACTYL_1, FRONTIER_MON_ZAPDOS_8}, // D, E - 21

    // Final Mode ("No Mans Land")
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F - 22
    ...
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F - 29
};
