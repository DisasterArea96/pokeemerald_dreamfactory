...
static const u16 sMoves_SlowAndSteady[] =
{
    ...
    MOVE_WILL_O_WISP, MOVE_TAUNT, MOVE_YAWN, MOVE_IMPRISON, MOVE_GRASS_WHISTLE, MOVE_FLY,
...
{
    // Level 5
    {FRONTIER_MON_AZURILL_LV5_1, FRONTIER_MON_ZUBAT_LV5_4},  // W, X  - 0
    {FRONTIER_MON_AZURILL_LV5_1, FRONTIER_MON_ZUBAT_LV5_4},  // W, X
    {FRONTIER_MON_AZURILL_LV5_1, FRONTIER_MON_ZUBAT_LV5_4},  // W, X
    {FRONTIER_MON_ARON_LV5_1, FRONTIER_MON_ZIGZAGOON_LV5_4}, // X, Y
    {FRONTIER_MON_ARON_LV5_1, FRONTIER_MON_ZIGZAGOON_LV5_4}, // X, Y
    {FRONTIER_MON_ARON_LV5_1, FRONTIER_MON_ZIGZAGOON_LV5_4}, // X, Y
    {FRONTIER_MON_ARON_LV5_3, FRONTIER_MON_ZIGZAGOON_LV5_6}, // Y, Z
    {FRONTIER_MON_ARON_LV5_3, FRONTIER_MON_ZIGZAGOON_LV5_6}, // Y, Z - 7 ~ Level 5 does not go beyond this

    // Level 50
    {FRONTIER_MON_ABRA_1, FRONTIER_MON_YANMA_2},      // A    - 8
    {FRONTIER_MON_ABRA_1, FRONTIER_MON_YANMA_2},      // A
    {FRONTIER_MON_ABRA_1, FRONTIER_MON_YANMA_2},      // A
    {FRONTIER_MON_ABSOL_3, FRONTIER_MON_XATU_4},      // B, C
    {FRONTIER_MON_ABSOL_3, FRONTIER_MON_XATU_4},      // B, C
    {FRONTIER_MON_ABSOL_3, FRONTIER_MON_XATU_4},      // B, C - 13

    // Open level
    {FRONTIER_MON_AGGRON_1, FRONTIER_MON_ZANGOOSE_4},   // C, D - 14
    {FRONTIER_MON_AGGRON_1, FRONTIER_MON_ZANGOOSE_4},   // C, D ~ Level 50 does not go beyond this
    {FRONTIER_MON_AGGRON_1, FRONTIER_MON_ZANGOOSE_4},   // C, D
    {FRONTIER_MON_AERODACTYL_1, FRONTIER_MON_ZAPDOS_8}, // D, E
    {FRONTIER_MON_AERODACTYL_1, FRONTIER_MON_ZAPDOS_8}, // D, E
    {FRONTIER_MON_AERODACTYL_1, FRONTIER_MON_ZAPDOS_8}, // D, E - 19

    // Final Mode ("No Mans Land")
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F - 20
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F ~ Open Level does not go beyond this
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F
    {FRONTIER_MON_AERODACTYL_1, NUM_FRONTIER_MONS - 1}, // D, E, F - 27
};
